...
# CODE TAKEN FROM sail-sg/understand-r1-zero git repo (understand_r1_zero/math_grader.py)

# Currently only using the boxed_reward_fn
...
def extract_answer(passage: str) -> str:
    if "\\boxed" in passage:
        ...
        sp = str(passage)
        if sp.rfind("\\boxed"):
            # print("string cast successful.")
            return extract_boxed_answer(sp)
        return None
